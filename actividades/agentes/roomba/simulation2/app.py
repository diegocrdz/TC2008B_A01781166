...
lineplot_component = make_plot_component(
    {
        "Roombas Alive": "tab:blue",
        "Total Trash Collected %": "tab:green",
        "Average Battery %": "tab:orange",
        "Average Movements": "tab:red",
        "Average Recharges": "tab:purple",
    },

    post_process=post_process_lines,
)

# Create space renderer for the grid
